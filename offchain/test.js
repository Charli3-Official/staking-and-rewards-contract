...
import {
  ...
  Reedemer,
  Certificate,
} from "./src/staking/validator.js";
import { tokenDatum, valueDatum, utxoDatum } from "./data_helper.js";
import { StakingState } from "./src/staking/validator.js";
import {
  RewardReedemer,
  to_reward_certificate_datum,
} from "./src/rewards/validator.js";
...
export function checkStakingRedeemerCbor() {
  ...
  const parsedRetireRedeemerHex = Data.to(
    Reedemer.retire(fromText("msg"), fromText("sig")),
  );

  const expectedWithdrawRedeemerHex = "d87a9f436d736743736967ff";
  const parsedWithdrawRedeemerHex = Data.to(
    Reedemer.withdraw(fromText("msg"), fromText("sig")),
  );

  const expectedResizeRedeemerHex = "d87b9f436d736743736967ff";
  const parsedResizeRedeemerHex = Data.to(
    Reedemer.resize(fromText("msg"), fromText("sig")),
  );
...
export async function checkStakingCertCbor() {
  const expectedHex =
    "d8799fd8799fd8799f5820768f32a1a557789b745688f3adb7ee33b4db47e6a4977ca3b070edea15f7b4b5ff00ff1b0000018b2202e264d8799f1b0000018b2202e264ffa140a1401a000f4240ff";
...
export async function checkStakingDatumCborWithoutCert() {
  const expectedHex =
    "d8799f581ce14edd775467a4e7bac7e98ce2fbb89157ab1dce924f30bea752cce39f4040ff1a0001e240d87980d87a80ff";
...
export async function checkStakingDatumCborWithCert() {
  const expectedHex =
    "";
...
export async function checkRewardCertificateDatumCbor() {
  ...
  const expectedHex =
    "d8799fd8799fd8799f5820768f32a1a557789b745688f3adb7ee33b4db47e6a4977ca3b070edea15f7b4b5ff00ff1b0000018b2202e264581ce14edd775467a4e7bac7e98ce2fbb89157ab1dce924f30bea752cce3a140a1401a000f4240ff";
...
export function checkRewardReedemerCbor() {
  const parsedSignedRewardRedeemerHex = Data.to(
    RewardReedemer.Signed(fromText("msg"), fromText("sig")),
  );
